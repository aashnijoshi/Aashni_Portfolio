      ...
      {project.images && project.images.length > 0 && (
        <div className="relative">
          {project.title === "Hyperspell" ? (
            <div className="grid grid-cols-2 gap-2 rounded-2xl overflow-hidden shadow-[0_12px_60px_-28px_rgba(0,0,0,0.45)] max-h-[320px]">
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-[0_12px_60px_-28px_rgba(0,0,0,0.45)] max-w-[280px]">
              <img
